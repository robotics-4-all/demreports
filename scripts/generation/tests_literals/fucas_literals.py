...
def fucas_literals(results):
    ...
    ret['examples'] = {
        ...
        "προοπτικής μνήμης": "να θυμηθεί να κάνει κάτι σε συγκεκριμένο χρόνο (π.χ. να πάρει το φάρμακό του την συγκεκριμένη ώρα, να κλείσει τον φούρνο, να πάει σε κάποιο προγραμματισμένο ραντεβού)", 
        "σχεδιασμού έργων": "να μπορεί να ορίσει τα βήματα προκειμένου να ολοκληρώσει ένα σύνθετο έργο (να μπορεί να σχεδιάσει ένα ταξίδι, ένα γεύμα για πολλά άτομα, να οργανώσει την ημέρα του)", 
