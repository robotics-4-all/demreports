...
def handle_visuospatial(parsed, document, literals):
    ...
    # input from Elena
    p1.add_run(f"{literals['article_lastname_mr_mrs_capital']}, {rocft_lits['copy_problem']} δυσκολίες στην αναπαραγωγή σύνθετων οπτικοχωρικών έργων, όπως διαπιστώθηκε μέσω της δοκιμασίας οπτικοχωρικής αντίληψης και μνήμης ROCFT. {mmse_lit}Τα παραπάνω ευρήματα συνηγορούν ότι για το χρονικό διάστημα στο οποίο αναφέρεται η εκτίμηση {literals['article_lastname_mr_mrs']} {problems}. ")
